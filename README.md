...
##  Project Overview
This project is a **Data Orchestration & Analytics Dashboard** designed to track the financial efficiency of some districts of Uttar Pradesh. Using real-world data from the **Open Government Data (OGD) Platform**, the tool identifies "Administrative Bottlenecks" by comparing sanctioned funds versus actual utilization.
